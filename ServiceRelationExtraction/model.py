...
class s_model(nn.Module):
    def __init__(self, word_dict_length, word_emb_size, lstm_hidden_size):
        ...
        self.linear_q = nn.Linear(word_emb_size*2, word_emb_size*2)
        self.linear_k = nn.Linear(word_emb_size*2, word_emb_size*2)
        self.linear_v = nn.Linear(word_emb_size*2, word_emb_size*2)
